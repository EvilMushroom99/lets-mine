...
public class ArrowUpBlock : MonoBehaviour, IBlockeable
{
    private readonly Vector3Int[] directions = { Vector3Int.up, Vector3Int.up * 2, Vector3Int.up * 3, Vector3Int.up * 4 };
